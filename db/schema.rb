...
ActiveRecord::Schema.define(version: 20180221182607) do

  create_table "aportes", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "transferencia", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.float "valor", limit: 24
    t.boolean "tipo"
